...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
	...
	, ((modMask .|. shiftMask,	xK_q),		spawn "gnome-session-quit --power-off")
	, ((modMask,				xK_F1),		spawn "gvim +/Keybindings ~/.xmonad/xmonad.hs") -- keybinding help
...
myManageHook = composeAll
	...
	, className =? "Empathy"		--> doShift "5:im"
